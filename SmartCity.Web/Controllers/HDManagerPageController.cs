...
namespace SmartCity.Web.Controllers
{
    ...
    public class HDManagerPageController : Controller
    {
        ...
        private IMedicineCertificateRepository certificateRepository;

        public HDManagerPageController(IMapper mapper, IMedicineCertificateRepository certificateRepository)
        {
            this.mapper = mapper;
